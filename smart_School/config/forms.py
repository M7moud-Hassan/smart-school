...
class ConfigForm(forms.ModelForm):
    ...
    token_access = forms.CharField(widget=forms.TextInput(
        attrs={'class': 'form-control', 'placeholder': 'YOUR_FACEBOOK_ACCESS_TOKEN'}))
    url_whatsapp = forms.URLField(widget=forms.URLInput(
        attrs={'class': 'form-control', 'placeholder': 'https://graph.facebook.com/v17.0/119791417748534/messages'}))
